...
| search.engine                  | SEARCH_ENGINE                  | `false`                  | enable search engine                                      |
| search.index_path              | SEARCH_INDEX_PATH              | `./var/search_index`     | search index location                                     |
| search.analyzer                | SEARCH_ANALYZER                | `standard`               | text analyzer type, set language-specific one to improve search quality |
